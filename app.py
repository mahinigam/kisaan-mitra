...
@app.route("/coldstorage")
def cold_storage():
    return render_template("cold_storage.html")


@app.route("/cold_storage_cards")
def cold_storage_cards():
    return render_template("cold_storage_cards.html")
...
def login_user():
    if request.method == "POST":
        ...
        if user_type == "farmer":
            ...
            user = cold_storages_collection.find_one(
